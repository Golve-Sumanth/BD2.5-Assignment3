...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    result.sort(sortByPriceAscending);
  } else {
    result.sort(sortByPriceDescending);
  }
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'high-to-low') {
    result.sort(sortByRatingDescending);
  } else {
    result.sort(sortByRatingAscending);
  }
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    result.sort(sortByReviewsAscending);
  } else {
    result.sort(sortByReviewsDescending);
  }

  res.json({ hotels: result });
});

app.get('/hotels/amenity/:amenity', (req, res) => {
...
app.get('/hotels/category/:category', (req, res) => {
